...
[assembly: ExportRenderer(typeof(PinchZoomContainer), typeof(PinchZoomRenderer))]
namespace MEI.Droid.CustomRenderers
{
    class PinchZoomRenderer : ViewRenderer
    {
        Context _context;
        public PinchZoomRenderer(Context context) : base(context)
        {
            _context = context;
        }
        ...
        public override bool OnTouchEvent(MotionEvent e)
        {
            var totalX = e.GetX();
            var totalY = e.GetY();
            var element = Element as PinchZoomContainer;
        ...
        private void EndPan(PinchZoomContainer element, float x, float y)
        {
